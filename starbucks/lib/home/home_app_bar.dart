...
class HomeAppBar extends StatelessWidget {
  ...
  Widget createRewardStatus(ColorScheme colorScheme) => Row(
    children: [
      Expanded(
        child: Column(
  ...
  List<Widget> createAppBarContentWidgets(ColorScheme colorScheme) => [
    Text(
      "한 해의 마무리,\n수고 많았어요💖",
      style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold),
    ),
    Spacer(),
    createRewardStatus(colorScheme),
  ];

  Widget createBottomUI(ColorScheme colorScheme) => Row(
    children: [
      TextButton.icon(
        onPressed: () => {},
    ...
    return SliverAppBar(
        ...
        background: Stack(
          children: [
            ...
            Positioned(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: createAppBarContentWidgets(colorScheme),
              ),
            ),
          ],
        ),
      ...
      bottom: PreferredSize(
        ...
        child: Padding(
          ...
          child: createBottomUI(colorScheme),
        ),
      ),
    );
  }
